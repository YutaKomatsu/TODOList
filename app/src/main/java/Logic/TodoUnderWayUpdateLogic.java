...
public class TodoUnderWayUpdateLogic {
    public boolean execute(TodoUnderWay todoUnderWay) {
        ...
        todoUnderWayPHP.execute("http://androidtest.php.xdomain.jp/UpdateTodoUnderWay.php",TodoUnderWayPHP.UPDATE_TODO_UNDER_WAY);
        try {
            latch.await();
